...
Usage:
    python tools/changelog_extract.py 0.1.0
    python tools/changelog_extract.py 0.1.0 path/to/CHANGELOG.md
...
# Matches a released section heading like "## [0.1.0]" (semver), but not "## [Unreleased]".
